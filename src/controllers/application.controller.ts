...
export const createApplication = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        // Give this user access to this new application and as the owner. 
        const userAppAccess = await ApplicationService.addUserToApp(newApplication.id, user.userId, 'owner');
        ...
        return res.status(201).json({
            ...
            data: {
                ...
                owner: userAppAccess.user.email
            }
        });
